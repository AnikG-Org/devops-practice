...
resource "aws_cloudfront_distribution" "cdn" {
  ...
  dynamic "origin" {
    ...
    content {
      ...
      dynamic "s3_origin_config" {
        ...
        content {
          origin_access_identity = lookup(s3_origin_config.value, "cloudfront_access_identity_path", lookup(lookup(aws_cloudfront_origin_access_identity.cdn, lookup(s3_origin_config.value, "origin_access_identity", ""), {}), "cloudfront_access_identity_path", null))
        }
      }
  ...
  dynamic "ordered_cache_behavior" {
    ...
    content {
      ...
      #   content {
      #     event_type   = l.key
      #     function_arn   = l.value.function_arn
      #     #include_body = lookup(l.value, "include_body", null)
      #   }
      # }
    }
